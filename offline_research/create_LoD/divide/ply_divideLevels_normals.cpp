...
int main(int argc, char** argv)
{
    ...
    if (pcl::io::loadPLYFile<pcl::PointXYZRGBNormal>(argv[1], *cloud) == -1)
    {
    ...
    vector<pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr> clouds(sampling_ratio);
    for(int i = 0; i < sampling_ratio; ++i) {
        clouds[i].reset(new pcl::PointCloud<pcl::PointXYZRGBNormal>);
    }
