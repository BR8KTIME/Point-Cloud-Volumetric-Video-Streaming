...
bool compare(const pcl::PointXYZRGBNormal& a, const pcl::PointXYZRGBNormal& b)
{
    if(a.x == b.x)
    {
        if(a.y == b.y)
...
int main(int argc, char** argv)
{
    ...
    if(pcl::io::loadPCDFile<pcl::PointXYZRGBNormal>(argv[1], *cloud) == -1)
    {
    ...
    pcl::octree::OctreePointCloudSearch<pcl::PointXYZRGBNormal> octree(voxel_size);
    ...
    pcl::octree::OctreePointCloud<pcl::PointXYZRGBNormal>::AlignedPointTVector voxel_centers;
    ...
    pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr level_0(new pcl::PointCloud<pcl::PointXYZRGBNormal>);
    pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr level_1(new pcl::PointCloud<pcl::PointXYZRGBNormal>);
    pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr level_2(new pcl::PointCloud<pcl::PointXYZRGBNormal>);
    pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr level_3(new pcl::PointCloud<pcl::PointXYZRGBNormal>);
    pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr level_4(new pcl::PointCloud<pcl::PointXYZRGBNormal>);
    pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr level_5(new pcl::PointCloud<pcl::PointXYZRGBNormal>);
    pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr level_6(new pcl::PointCloud<pcl::PointXYZRGBNormal>);
    pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr level_7(new pcl::PointCloud<pcl::PointXYZRGBNormal>);
    pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr level_8(new pcl::PointCloud<pcl::PointXYZRGBNormal>);
    pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr level_9(new pcl::PointCloud<pcl::PointXYZRGBNormal>);
    ...
    for (const auto& voxel_center : voxel_centers)
    {
        ...
        if (octree.voxelSearch(voxel_center, point_idx_vec))
        {
            ...
            vector<pcl::PointXYZRGBNormal> points;
    ...
    {
        string s;
        // string path = "../../../../dataset/pcd_files/visual_importance/octree_LoD/with_normals/20_levels/";
        // string path = "/var/www/dataset/loot/visual/with_normals/10_levels/";
        string format = ".pcd";
        s = "level" + to_string(i);
