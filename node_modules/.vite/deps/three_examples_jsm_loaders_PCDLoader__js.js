import { J as BufferGeometry, To as SRGBColorSpace, Ur as Loader, bn as Float32BufferAttribute, ca as Points, er as Int32BufferAttribute, la as PointsMaterial, st as Color, vn as FileLoader } from "./three.module-L0vMa_aS.js";
//#region node_modules/three/examples/jsm/loaders/PCDLoader.js
/**
	...
	*/
	parse(data) {
		...
		if (PCDheader.data === "ascii") {
			...
			const lines = new TextDecoder().decode(data).slice(PCDheader.headerLen).split("\n");
			for (let i = 0, l = lines.length; i < l; i++) {
				...
				if (offset.rgb !== void 0) {
					...
					let rgb = float;
					if (rgb_type === "F") {
						const farr = /* @__PURE__ */ new Float32Array(1);
						farr[0] = float;
				...
				if (offset.intensity !== void 0) intensity.push(parseFloat(line[offset.intensity]));
				if (offset.label !== void 0) label.push(parseInt(line[offset.label]));
			}
		}
		...
		const material = new PointsMaterial({ size: .005 });
