	...
	search(bbox) {
		...
		while (node) {
			for (let i = 0; i < node.children.length; i++) {
				...
				if (intersects$1(bbox, childBBox)) if (node.leaf) result.push(child);
...
var import_point_in_polygon = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var resulterrbound = 3.000000000000001 * epsilon;
...
vec(1152);
//#endregion
//#region node_modules/concaveman/index.js
...
function noIntersections(a, b, segTree) {
	...
	for (let i = 0; i < edges.length; i++) if (intersects(edges[i].p, edges[i].next.p, a, b)) return false;
	return true;
}
...
function fastConvexHull(points) {
	...
	for (let i = 0; i < points.length; i++) if (!(0, import_point_in_polygon.default)(points[i], cull)) filtered.push(points[i]);
